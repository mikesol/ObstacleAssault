...
UNREALROOTPATH = /home/meeshkan-abel/mike/unreal/UnrealEngine-5.1.0-release
GAMEPROJECTFILE =/home/meeshkan-abel/Documents/UnrealProjects/ObstacleAssault/ObstacleAssault.uproject

TARGETS = \
	ObstacleAssault-Linux-Debug  \
	ObstacleAssault-Linux-DebugGame  \
	ObstacleAssault-Linux-Test  \
	ObstacleAssault-Linux-Shipping  \
	ObstacleAssault \
	ObstacleAssaultEditor-Linux-Debug  \
	ObstacleAssaultEditor-Linux-DebugGame  \
	ObstacleAssaultEditor-Linux-Test  \
...
ObstacleAssault-Linux-Debug:
	 $(PROJECTBUILD) ObstacleAssault Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ObstacleAssault-Linux-DebugGame:
	 $(PROJECTBUILD) ObstacleAssault Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ObstacleAssault-Linux-Test:
	 $(PROJECTBUILD) ObstacleAssault Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
ObstacleAssaultEditor-Linux-Debug:
	 $(PROJECTBUILD) ObstacleAssaultEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ObstacleAssaultEditor-Linux-DebugGame:
	 $(PROJECTBUILD) ObstacleAssaultEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ObstacleAssaultEditor-Linux-Test:
	 $(PROJECTBUILD) ObstacleAssaultEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
